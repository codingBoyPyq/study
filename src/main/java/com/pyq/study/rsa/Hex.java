...
public class Hex {
     ...
     * @return 十六进制String
     */
    public static String encodeByteToHexStr(byte[] data) {
     ...
     * @throws RuntimeException 如果源十六进制字符数组是一个奇怪的长度，将抛出运行时异常
     */
    public static byte[] decodeHexstrToByte(String hexStr) {
    ...
    public static void main(String[] args) {
        ...
        String encodeStr = encodeByteToHexStr(srcStr.getBytes());
